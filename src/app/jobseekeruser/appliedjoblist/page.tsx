...
export default function AppliedJobList() {
  return (
    <div className="md:px-12 min-h-screen mt-9 mx-3">
      {/* Header */}
          ...
          <div className="bg-primary text-white px-6 py-3 rounded-t-lg text-sm md:text-base lg:text-lg font-medium">
            <div className="grid grid-cols-7 gap-4">
              <div className="col-span-1 flex items-center">
                Applied Date <CgArrowsV className="ml-1" />
              </div>
              <div className="col-span-1 flex items-center">
                Company Name <CgArrowsV className="ml-1" />
              </div>
              <div className="col-span-1 flex items-center">
                Contact <CgArrowsV className="ml-1" />
              </div>
              <div className="col-span-1 flex items-center">
                Salary Range <CgArrowsV className="ml-1" />
              </div>
              <div className="col-span-1 flex items-center">
                Position <CgArrowsV className="ml-1" />
              </div>
              <div className="col-span-1 flex items-center">
                Status <CgArrowsV className="ml-1" />
              </div>
              <div className="col-span-1 flex items-center">
                Action <CgArrowsV className="ml-1" />
              </div>
            </div>
          </div>
            ...
            {aiLogData.map((row) => (
              ...
              >
                <div className="grid grid-cols-7 gap-4 items-center text-gray-700">
                  ...
                  <div className="col-span-1 underline text-primary">
                    View Details
                  </div>
                </div>
              </div>
