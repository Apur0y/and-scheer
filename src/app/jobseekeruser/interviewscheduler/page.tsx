        ...
        <div className="min-w-[600px]">
          ...
          <div className="bg-primary px-6 rounded-t-lg">
            <div className="grid grid-cols-12 gap-4 py-3 text-white text-md lg:text-xl ">
              <div className="col-span-2 flex items-center">
                Company Name <CgArrowsV className="my-auto ml-1" />
              </div>
              <div className="col-span-2 flex items-center">
                Interviewer name <CgArrowsV className="my-auto ml-1" />
              </div>
              <div className="col-span-2 flex items-center">
                Position <CgArrowsV className="my-auto ml-1" />
              </div>
              <div className="col-span-2 flex items-center">
                Interview Date <CgArrowsV className="my-auto ml-1" />
              </div>
              <div className="col-span-2 flex items-center">
                Interview Link <CgArrowsV className="my-auto ml-1" />
              </div>
              <div className="col-span-2 flex items-center">
          ...
          <div className="divide-y divide-gray-200">
            {aiLogData.map((row) => (
              ...
              >
                <div className="grid grid-cols-12 gap-4 items-center text-sm md:text-[16px] text-primary-dark">
                  ...
                  <div className="col-span-2 flex gap-2 underline">
                    <Link2Icon /> interview link
                  </div>
                  <div className="col-span-2 text-primary underline">
                    Chat Now
                  </div>
                </div>
              </div>
