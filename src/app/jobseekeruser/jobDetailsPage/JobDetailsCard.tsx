...
const JobDetailsCard: React.FC<JobDetailsCardProps> = ({ currentCompany }) => {
  ...
  return (
    <section className="max-w-[939px] mx-auto p-6 bg-white text-primary-dark shadow-md rounded-lg">
      <header className="flex justify-between items-center mb-4">
        <h1 className="text-2xl md:text-5xl font-bold  dark:">
          {currentCompany?.name || "dask"}
        </h1>
      ...
      <h2 className="text-xl md:text-[42px]   dark:">
        {currentCompany?.position || "UI/UX Designer (Onsite)"}
      </h2>
      ...
      <p className="text-sm  dark: mt-2">
        <strong className=" dark:">Skills:</strong> Figma, Adobe Illustrator,
        Photoshop, Adobe XD (optional)
      </p>
      ...
      <section className="mt-6">
        ...
        <p className=" dark:">
          We are looking for a talented UI/UX Designer to join our onsite team
          in Dhaka. You'll work closely with PMs and developers to design
      ...
      <section className="mt-6">
        <h3 className="text-lg font-semibold  dark: mb-2">
