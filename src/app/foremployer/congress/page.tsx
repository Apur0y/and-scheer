...
export default function CompanyProfileComplete() {
  return (
    <div className="max-w-[1420px] mx-auto px-4 py-10 flex flex-col items-center space-y-6 min-h-screen justify-center text-primary-dark">
      {/* Party Icon Placeholder */}
      <div className="w-16 h-16" />
      <Image src={"/congress.png"} alt="" height={250} width={250} />
      ...
      <button className="px-6 py-3 bg-primary text-white rounded-lg font-semibold flex items-center gap-2">
        Go to Dashboard →
      </button>
    </div>
  );
