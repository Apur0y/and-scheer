            ...
            <div>
                ...
                <div className=" mx-auto bg-white   rounded-md p-9 border border-gray-300 space-y-6 ">
                    ...
                    <div className=" border-gray-200 ">
                        ...
                        <div className="space-y-2 text-sm text-gray-700">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="font-medium text-gray-900">April 30, 2025 | 08:50 AM</span>
                            </div>
                            <div className="flex justify-between">
                    ...
                    <div className=" border-gray-200">
                        ...
                        <button className="w-full bg-scheer-primary border-none hover:bg-green-700 text-white py-2 px-4 rounded-md transition flex items-center justify-center">
                            Create Company Profile<BiRightArrowAlt className='size-6'/>
                        </button>
                    </div>
                </div>
            </div>
